...
/**
 * \file    test/phpunit/MMIFiltersFunctionalTest.php
 * \ingroup mmifilters
...
/**
 * Class MMIFiltersFunctionalTest
 *
 ...
 *
 * @package Testmmifilters
 */
class MMIFiltersFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIFilters')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIFilters')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmifilters/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmifilters/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmifilters/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmifilters/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmifilterswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIFilters_MMIFiltersTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIFilters_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
